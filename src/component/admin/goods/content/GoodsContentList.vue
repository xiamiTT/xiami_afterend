<template>
    <div class="list">
        ...
        <el-table ref="multipleTable" :data="tableList" tooltip-effect="dark" style="width: 100%" height="400">
            ...
            <el-table-column width="100" label="状态">
                ...
                <template slot-scope="scope">
                    ...
                    <i :class="['el-icon-setting', scope.row.is_hot? 'active': '']"></i>
                    <i :class="['el-icon-sort', scope.row.is_slide? 'active': '']"></i>
                </template>
            </el-table-column>
        ...
        <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="query.pageIndex" :page-size="query.pageSize" :page-sizes="[10, 20, 30, 40]" layout="total, sizes, prev, pager, next, jumper" :total="totalcount">
        </el-pagination>
    </div>
</template>
